...
public class ReplyServiceImpl implements ReplyService {
	...
	public Reply getReplyItem(Reply input) throws Exception {
		...
		try {
			result = sqlSession.selectOne("ReplyMapper.selectItem", input);
	...
	public int deleteReply(Reply input) throws Exception {
        ...
        try {
            result = sqlSession.delete("ReplyMapper.deleteItem", input);
	...
	public List<Reply> getReplya1_1admin(Reply input) throws Exception {
        ...
        try {
            result = sqlSession.selectList("ReplyMapper.selectListadmin1_1", input);
