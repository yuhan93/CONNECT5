...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/assets/css/HG/Mypage/personal_information1.css">
								...
								.click(
										function() {
											...
											if ($("#user_pw").val() == "") {
												...
												location.href = "${pageContext.request.contextPath}/_mypage/personal_information2_HG.do";
												return;
											}
