...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/YH/Admin/admin_userManagementRead_YH.css">
...
<body>
	<div class="container">
		...
		<div class="col-md-10 text_box">
							...
							<th class="text_select" colspan="2">
								<c:choose>
									<c:when test="${nextBoard != null}">
										<c:url var="nextUrl" value="/_admin/admin_userManagementview.do">
							...
							<th class="text_select" colspan="2">
								<c:choose>
									<c:when test="${prevBoard != null}">
										<c:url var="prevUrl" value="/_admin/admin_userManagementview.do">
											<c:param name="Title" value="${Title}" />
			...
			<button class="btn btn-default" onclick="location.href = '${pageContext.request.contextPath}/_admin/admin_userManagementedit.do?BoardId=${output.getBoardId() }'">수정하기</button>
			<button class="btn btn-default" onclick="location='${pageContext.request.contextPath}/_admin/admin_userManagement_YH.do'">목록</button>
		</div>
	</div>
