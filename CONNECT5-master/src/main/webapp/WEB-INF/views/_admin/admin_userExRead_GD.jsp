	...
	<a href="${pageContext.request.contextPath}/_admin/admin_main_SE.do"
		...
		<div class="col-md-10 text_box">
							...
							<th class="text_select" colspan="2">
								<c:choose>
									<c:when test="${nextBoard != null}">
										<c:url var="nextUrl" value="/_admin/admin_userExRead_GD.do">
							...
							<th class="text_select" colspan="2">
								<c:choose>
									<c:when test="${prevBoard != null}">
										<c:url var="prevUrl" value="/_admin/admin_userExRead_GD.do">
											<c:param name="Title" value="${Title}" />
			...
			<button class="btn btn-default"
				onclick="location.href = '${pageContext.request.contextPath}/_admin/admin_userExdeleteOk_GD.do?BoardId=${output.getBoardId() }'">삭제하기</button>
			<button class="btn btn-default"
