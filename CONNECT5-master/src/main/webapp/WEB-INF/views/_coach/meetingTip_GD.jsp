				...
				<c:choose>
					...
					<c:otherwise>
						...
						<c:forEach var="item" items="${output}" varStatus="status">
							<%--출력을 위해 준비한 학과이름과 위치 --%>
							<c:url value="/_coach/readTip_GD.do" var="viewUrl">
			...
			<div align="center">
				...
				<c:choose>
					...
					<c:when test="${pageData.prevPage > 0}">
						<%-- 이동할 URL 생성 --%>
						<c:url value="/_coach/meetingTip_GD.do" var="prevPageUrl">
				...
				<c:forEach var="i" begin="${pageData.startPage}"
					...
					<%-- 이동할 URL 생성 --%>
					<c:url value="/_coach/meetingTip_GD.do" var="pageUrl">
				...
				<c:choose>
					...
					<c:when test="${pageData.nextPage > 0}">
						<%-- 이동할 URL 생성 --%>
						<c:url value="/_coach/meetingTip_GD.do" var="nextPageUrl">
