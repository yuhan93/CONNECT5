...
<body>
	...
	<div class="boximg">
		<img src="${pageContext.request.contextPath}/assets/img/review1.jpg"
		...
		<div class="left sidebar1">
			...
			<div class="list-group">
				<a href="${pageContext.request.contextPath}/_coach/meetingTip_GD.do"
					...
					class="list-group-item btncolor">연-결 만남 후기</a> <a
	...
	<div class="search">
		<form method="get"
			action="${pageContext.request.contextPath}/_coach/review_SE.do">
			<ul id="key">
					<li>
	...
	<div class="col-md-10 content">
		...
		<button class="btn btn-default"
			onclick="location.href = '${pageContext.request.contextPath}/_coach/reviewWrite_SE.do'">글쓰기</button>
